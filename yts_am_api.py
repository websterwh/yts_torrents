...
def add_torrent_to_json_file(json_file_number):
    ...
    with open(name, 'r') as f:
        content = json.load(f)
    content[title_long] = {'720_bluray': torrent_720_bluray, '1080_bluray': torrent_1080_bluray, '2160_bluray': torrent_2160_bluray,
                           '720_web': torrent_720_web, '1080_web': torrent_1080_web, '2160_web': torrent_2160_web}
    with open(name, 'w') as f:
        json.dump(content, f)
...
url = "https://yts.mx/api/v2/list_movies.json?limit=50&page="
...
for page in range(1, 424):
    ...
    for movie in movies:
        ...
        torrent_2160_web = None
        torrent_2160_bluray = None
        ...
        for torrent in torrents:
            ...
            elif torrent.get('quality') == "2160p":
                if torrent.get('type') == "web":
                    torrent_2160_web = torrent.get('url')
                elif torrent.get('type') == "bluray":
                    torrent_2160_bluray = torrent.get('url')
